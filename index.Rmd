...
Este documento presenta una tabla y varios gráficos estadísticos de los datos de estadísticas policiales en 2021 en Costa Rica publicados por el Organismo de Investigación Judicial en [página web de datos abiertos del Organismo de Investigación Juficial (OIJ)]([OIJ](https://sitiooij.poder-judicial.go.cr/))
